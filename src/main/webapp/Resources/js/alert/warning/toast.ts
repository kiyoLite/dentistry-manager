...
const createToastWarning = function (toastMessage: toastMessage) {
    const toast = document.createElement("div");
    toast.innerHTML = `
        <div class="ContainerImage">
            <img src="../images/warningIcon.svg" alt="" class="Image">
        </div>
...
const leftScreenToastWarning = function (toastMessage: toastMessage) {
