...
const createToastSuccess = function (toastMessage) {
    const toast = document.createElement("div");
    toast.innerHTML = `
        <div class="ContainerImage">
            <img src="../images/Check.svg" alt="" class="Image">
        </div>
...
const leftScreenToastSuccess = function (toastMessage) {
...
const middleScreenToastSuccess = function (toastMessage) {
    const toast = createToastSuccess(toastMessage);
    toast.style.top = "50%";
    toast.style.left = "50%";
