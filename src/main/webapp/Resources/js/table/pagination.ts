...
const blockPagination = function () {
    const filterOptions = document.getElementById("FilterBy") as HTMLSelectElement | null;
    const searchBar = document.getElementById("SearchRegisterInput") as HTMLInputElement | null;
